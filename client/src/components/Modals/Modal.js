...
class GeneralModal extends Component {
	...
	handleRequestClose = () => {
		this.props.pre_close(); // optional callback before close
		this.closeModal();
		this.props.post_close(); // optional callback after close
	};
	handleAfterOpen = () => {
		this.props.pre_after_open(); // optional callback before after open runs
		this.afterOpenModal();
		this.props.post_after_open(); // optional callback after opened
	};
	...
	addOverlayEffects = () => {
		...
		// ! maybe deprecated
		//--------------------------------------------------
		document.querySelector(this.props.rootSelector).classList.add('blur-for-modal');
	};

	removeOverlayEffects = () => {
		document.querySelector(this.props.rootSelector).classList.remove('blur-for-modal');
	};
